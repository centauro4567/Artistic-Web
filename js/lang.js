window.addEventListener('load', ()=>{
    ...
    lang.addEventListener('mouseup', ()=>{
        ...
        if(lang.value == 'english'){
            ...
            intro.innerHTML = '<p>To those who feel the world moving so fast... To those who need just stop and breathe... To those who want find yourselfs... just a moment... in a "no place"... this music is for you</p>'
