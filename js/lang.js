window.addEventListener('load', ()=>{
    ...
    lang.addEventListener('mouseup', ()=>{
        ...
        if(lang.value == 'english'){
            ...
            bio.innerHTML = '<p>My name is Ladislao Martínez and I am a musician and composer... And I created this website with the intention of giving my sounds to those people who need a moment of peace ... I hope you enjoy it and relax</p>'
            ...
            bio.innerHTML = '<p>Mi nombre es Ladislao Martínez y soy músico y compositor... Y creé esta web a con la única intensión de regalar mis sonidos a aquellas personas que necesiten un momento de paz... Espero que lo disfruten y se relajen</p>'
